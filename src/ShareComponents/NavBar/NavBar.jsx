...
const NavBar = () => {
    ...
    return (
        <>
            <div className='w-full bg-[#f2f2f2] h-20 fixed opacity-90 z-20 dark:bg-slate-700'>
            ...
            <div className='flex flex-col bg-base-300 gap-5 font-semibold md:hidden w-48 pt-20 items-center fixed z-10 transition-all dark:bg-slate-700 dark:text-white' style={{ left: `${show ? '0px' : "-192px"}` }}>
                <NavLink to={'/'}>Home</NavLink>
                <NavLink to={'/instractors'}>Instructors</NavLink>
                <NavLink to={'/allCourses'}>Courses</NavLink>
                {user && <NavLink to={'/dashboard'}>Dashboard </NavLink>}
